...
#include "BehaviorTree/BTComposite_Selector.h"
...
UBehaviorTree* UPlayerBehaviorTreeBuilder::BuildBehaviorTreeFromSnapshot(const FPlayerEvaluationSnapshot& Snapshot)
{
    ...
    UBTComposite_Selector* RootSelector = NewObject<UBTComposite_Selector>(BehaviorTree, FName(TEXT("RootSelector")));
...
{
    UBTComposite_Sequence* Sequence = NewObject<UBTComposite_Sequence>(TreeOuter, FName(TEXT("AggressiveBranch")));
...
{
    UBTComposite_Sequence* Sequence = NewObject<UBTComposite_Sequence>(TreeOuter, FName(TEXT("ExplorationBranch")));
...
{
    UBTComposite_Sequence* Sequence = NewObject<UBTComposite_Sequence>(TreeOuter, FName(TEXT("SurvivalBranch")));
...
{
    UBTComposite_Sequence* Sequence = NewObject<UBTComposite_Sequence>(TreeOuter, FName(TEXT("SupportBranch")));
