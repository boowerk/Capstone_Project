...
namespace EnemyBlackboardKeys
{
	...
	const FName RetreatThreshold(TEXT("RetreatThreshold"));
	const FName ChasePersistence(TEXT("ChasePersistence"));
	...
	const FName bShouldReturnHome(TEXT("bShouldReturnHome"));
