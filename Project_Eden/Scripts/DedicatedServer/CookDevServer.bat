...
call "%RUN_UAT%" BuildCookRun -project="%UPROJECT%" -noP4 -server -noclient -serverplatform=Win64 -serverconfig=Development -nocompile -nocompileeditor -cook -stage -package -pak -archive -archivedirectory="%ARCHIVE_DIR%" -map=/Game/Maps/DemoMap/ServerEmptyTest -utf8output %*
pause
exit /b %ERRORLEVEL%
