...
- Commits `7dbebaba`, `cde64ad5`, `b1e740c5`, `bc692729`, `4b1452c0`, and `6b0b58ac` add `Telegraph VFX On/Off` and connect non-Sans damaging GAS patterns. Crystal Seraph and Matador inherit `BossTelegraphVFXComponent`; Dark Knight reuses its existing `GP_BossTelegraphVFX` BP component. Select the component, choose Niagara System Asset, set Telegraph Duration/Uniform Visual Scale, and enable the bool. Groggy and Crystal teleport stay immediate. Build, configuration/exclusion automation, and legacy charge automation pass; PIE-check timing and placement on each attack.
