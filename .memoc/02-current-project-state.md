...
Last synced: 2026-06-02T20:51:00+09:00
...
- Dash uses source dodge montages during active primary melee: `UGP_Dash` snapshots active `UGP_Primary` before its cancel tags run, chooses `SourceDodgeMontages.Left_RM/Right_RM` by local movement direction, and leaves normal roll/source-roll behavior unchanged outside primary melee.
